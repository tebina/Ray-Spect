...
file = open('netlist/quadruple_sbox/netlist', 'r')
sample = file.read()
...
#     region_count += 1
#     def_obj = DefParser("netlist/quadruple_sbox/sboxTOP.def", rectangle[0], rectangle[1])
#     fetched_instances = def_obj.region_fetch()
#     netlist_obj = pp(parsed_netlist, fetched_instances, "vthadd", 0.5)
#     netlist_obj.generate_netlist("quadruple_sbox/generated_regional/regional_netlist" + str(region_count))
#
#     del def_obj
#     del netlist_obj
...
def_obj = DefParser("netlist/quadruple_sbox/sboxTOP.def", (0, 0), (600, 600))
fetched_instances = def_obj.region_fetch()
netlist_obj = pp(parsed_netlist, fetched_instances, "vthadd", 0.5)
netlist_obj.generate_netlist("quadruple_sbox/generated_regional/regional_netlist")
